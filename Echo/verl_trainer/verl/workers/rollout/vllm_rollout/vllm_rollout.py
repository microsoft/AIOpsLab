...
class vLLMRollout(BaseRollout):
    ...
    def save_batch_rollouts(self, batch: TensorDict, batch_id: int = None):
        """Save the batch rollouts to a file."""
        ...
        pt_file = os.path.join(self.rollouts_save_dir, f"rollout_batch_{batch_id}.pt")
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if self.save_rollout:
            self.save_batch_rollouts(batch)
