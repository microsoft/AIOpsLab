  ...
  <div style="margin-top: 6px; margin-bottom: 20px;" class="column has-text-centered">
      <div class="nav">
          <span class="nav-block">
              <a href="https://microsoft.github.io/AIOpsLab/" class="link-btn">
...
<div class=textdiv>
    ...
    <p style="font-size:20px;">We showcase the key results on the leaderboard. If you'd like your results to appear, please email us at <a href="mailto:AIOpsLab@microsoft.com">AIOpsLab@microsoft.com</a>. 
  <br>
